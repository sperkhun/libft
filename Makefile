...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/10/27 14:42:51 by sperkhun          #+#    #+#              #
#    Updated: 2017/12/07 15:15:33 by sperkhun         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c\
	...
	ft_isspace.c ft_islower.c ft_isupper.c ft_cntwrd.c ft_arrdel.c ft_sqrt.c\
	ft_lstlen.c ft_lstend.c ft_lstrev.c get_next_line.c
